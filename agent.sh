...
if [ -f $apache/lib/tomcat-catalina-jmx-remote-8.* ]
then
	echo "Jmx Remote already exists" 
else 
	wget -q \
	-P /lib/ \
	http://repo2.maven.org/maven2/org/apache/tomcat/tomcat-catalina-jmx-remote/8.0.28/tomcat-catalina-jmx-remote-8.0.28.jar
fi	
